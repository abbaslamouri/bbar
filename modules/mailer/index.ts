...
import { createResolver, defineNuxtModule, addServerHandler, addTemplate, useLogger } from 'nuxt/kit'

const PACKAGE_NAME = 'mailer'
...
export default defineNuxtModule({
  ...
  setup(moduleOptions, nuxt) {
    ...
    nuxt.options.runtimeConfig.mailer = defu(nuxt.options.runtimeConfig.mailer, options)
